...
<nav class="navbar navbar-expand-lg navbar-light bg-white px-lg-3 py-lg-2 shadow-sm sticky-top">
    ...
    <a class="navbar-brand me-5 fw-bold fs-3 h-font" href="index.php">Fair Catch Hotel</a>

    <button id="nav-bar" class="navbar-toggler shadow-none" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <span class="badge bg-light text-dark mb-3 text-wrap lh-base">
          Note: Your details must match with your ID (Pag-ibig card, SSS card, Passport, Driving license, etc.) that will be required during check-in.
        </span>
        <div class="container">
          <div class="row">
