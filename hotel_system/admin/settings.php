    ...
    <div class="row">
        ...
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-body">
                ...
                <p class="card-text"></p>
                No customers will be allowed to book hotel rooms when the shutdown mode is enabled. This is useful when you want to perform maintenance on the website or the hotel.
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="mb-4">
                        ...
                        <i class="bi bi-telephone-fill">+63</i>
                        <span id="pn1"></span>
                        </p>
                        <p class="card-text">
                        <i class="bi bi-telephone-fill">+63</i>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="mb-4">
                        ...
                        <iframe id="iframe" class="border p-2 w-100" height="200" loading="lazy"></iframe>
                    </div>
                </div>
